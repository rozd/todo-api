...
const httpResponseCodes = new Map<number, string>([
    [100, 'Continue'],
...
export class Whoops {
    ...
    public static internal(message: string, data?: object, statusCode: number = 500): WhoopsError {
    ...
    public internal(message: string, data?: object, statusCode = 500) {
